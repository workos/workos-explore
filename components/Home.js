    ...
    <main className="py-10">
      <Toast.Provider>
        ...
        <Toast.Root
          ...
          className="bg-white p-5 rounded-md fixed shadow-xl right-8 bottom-8 w-1/3 justify-between z-10 flex"
        >
          <div>
            <Toast.Title className="text-xl">Candidate Advanced</Toast.Title>
            <Toast.Description className="text-sm">
              Offer email will be sent automatically.
            </Toast.Description>
          </div>
