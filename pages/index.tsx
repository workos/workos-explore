          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
            {sections.map((section) => (
              <a
                key={section.title}
                href={section.url}
                className={`col-span-1 flex items-center justify-center gap-3 py-20 px-20 bg-gray-50 transition text-gray-400 hover:text-indigo-200 hover:bg-indigo-500`}
              >
                <div className="max-h-12" dangerouslySetInnerHTML={{ __html: section.icon }} />
